# Operator Quickstart — Health Care and Social Services Regulatory Administration

Shortest path from clone to a verified local dry-run for **ISIC 8412** (`cloud-itonami-isic-8412`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8412.git
cd cloud-itonami-isic-8412
```
...
- Blueprint governor key: `social-health-regulatory-governor`
